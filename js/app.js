...
function buscarClima(e){
   ...
   // Validar
    ...
    if (ciudad==='' || pais==='') {
       //Hubo un error
       mostrarError('Amobos campos son obligatorios');
...
function consultarAPI(ciudad,pais) {
     ...
     const appId='115c5e066b178f74d4c86b3fb7ba6c13';
...
function mostrarClima(datos) {
    ...
    tempMaxima.innerHTML=`Max : ${maxCentigrados} &#8451;`;
    tempMaxima.classList.add('text-2xl');

    const tempMinima = document.createElement('p');
    tempMinima.innerHTML=`Min : ${minCentigrados} &#8451;`;
